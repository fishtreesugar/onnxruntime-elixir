defmodule OnnxRuntime.TestSlice do
  use ExUnit.Case
  ...
  defp tensor_onnxruntime(tensor, dtype) do
    tensor
    |> Nx.as_type(dtype)
  ...
  test "1d slice f32" do
    ...
    ort = tensor_onnxruntime(@tensor1d, :f32) |> Nx.slice([0], [4]) |> Nx.backend_transfer()
  ...
  test "2d slice f32" do
    ...
    ort =
      tensor_onnxruntime(@tensor2d, :f32)
      |> Nx.slice([0, 2], [4, 6])
      |> Nx.backend_transfer()
  ...
  test "1d slice u8" do
    ...
    ort = tensor_onnxruntime(@tensor1d, :u8) |> Nx.slice([0], [4]) |> Nx.backend_transfer()
  ...
  test "2d slice u8" do
    ...
    ort =
      tensor_onnxruntime(@tensor2d, :u8)
      |> Nx.slice([0, 2], [4, 6])
      |> Nx.backend_transfer()
  ...
  test "1d slice f32 strided" do
    ...
    ort =
      tensor_onnxruntime(@tensor1d, :f32)
      |> Nx.slice([0], [4], strides: [2])
      |> Nx.backend_transfer()
  ...
  test "1d slice u8 strided" do
    ...
    ort =
      tensor_onnxruntime(@tensor1d, :u8)
      |> Nx.slice([0], [4], strides: [2])
      |> Nx.backend_transfer()
